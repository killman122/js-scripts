...
def 得物商品提交(spuId):
    ...
    headers = {'Host': 'app.dewu.com', 'Connection': 'keep-alive', 'ua': 'duapp/5.22.3(android;11)', 'appid': 'h5',
               'SK': '9JgSKkxfRab52YsrdOjH54LecF84HNlf5diZf1Bar21LuO2dT61f7BMr3jx71zpgBz2FenzLWbqdN4ucytOKTa9FJr1u',
               'shumeiId': '202206201105599577aec2d8302d653009c385871e64ef01dab1c9dbe482cd',
               'deviceTrait': 'Redmi+Note+8+Pro',
               'x-auth-token': 'Bearer eyJhbGciOiJSUzI1NiJ9.eyJpYXQiOjE2OTQ3MDE3NTAsImV4cCI6MTcyNjIzNzc1MCwiaXNzIjoiNGU2OTJhNDBkY2JlNTJkNSIsInN1YiI6IjRlNjkyYTQwZGNiZTUyZDUiLCJ1dWlkIjoiNGU2OTJhNDBkY2JlNTJkNSIsInVzZXJJZCI6MTUyNzk0MTAyMywidXNlck5hbWUiOiLmhKTmgJLkuZTmsrvln45SYkQiLCJpc0d1ZXN0IjpmYWxzZX0.V6J1xzo5e8aI6hMoCgSIxsk_Ouu13BnyocFWI5L95Dv0x-JXEiT_IyP8Wd7BOi37UnfJyHskRzY9DGUBp4QBotZS1BY1k_0qAu1kh_LtKd9ENDzvQfG1v-KYHBUY6tLgUj9rgW_CmcWqIKVkDJrj5MgjM0OZCPJP0bA1Lb6BTvQqCQHyHZhnSs91adF-9CoYffYCQAhIY886RBPWNy9ItCZEPvIaSwpjvKClaSt4MqPvJNwFOOBWRMW7JsleMMmmTJcJ8Xt9dKJeHu2u_gaZlDJEx0Ll4jucVVSa3uv54iYwrnf-teY6OCxWD_C28AmoLV4DIR-HSTjMVDNdIWkTqg',
               'uuid': '4e692a40dcbe52d5', 'channel': 'du',
               'duToken': 'd41d8cd9|1527941023|1694615853|6387eb79f63f8bdc',
               'appVersion': '5.22.3', 'emu': '0', 'cookieToken': 'd41d8cd9|1527941023|1694615853|6387eb79f63f8bdc',
               'User-Agent': 'Mozilla/5.0 (Linux; Android 11; Redmi Note 8 Pro Build/RP1A.200720.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/87.0.4280.141 Mobile Safari/537.36/duapp/5.22.3(android;11)',
               'isRoot': '0', 'imei': '', 'platform': 'h5', 'isProxy': '0', 'Accept': '*/*',
               'Origin': 'https://m.dewu.com',
               'X-Requested-With': 'com.shizhuang.duapp', 'Sec-Fetch-Site': 'same-site', 'Sec-Fetch-Mode': 'cors',
               'Sec-Fetch-Dest': 'empty', 'Referer': 'https://m.dewu.com/h5-newbie/super-deal-product?source=csyihanger',
               'Accept-Language': 'zh-CN,zh;q=0.9,en-US;q=0.8,en;q=0.7',
               'Cookie': 'duToken=d41d8cd9|1527941023|1694615853|6387eb79f63f8bdc', 'Content-Type': 'application/json'}
    data = {"spuId": spuId}
