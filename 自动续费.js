...
let ddnstock = ($.isNode() ? process.env.ddnstock : $.getdata('ddnstock')) || '1111';//检测环境变量中是否有ck
let ddnstockArr = []
let csrftoken = ($.isNode() ? process.env.csrftoken : $.getdata('csrftoken')) || '11111';//检测环境变量中是否有token
let csrftokenArr = []
